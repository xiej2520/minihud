...
public class Configs implements IConfigHandler
{
    ...
    public static class Generic
    {
        ...
        public static final ConfigInteger       LIGHT_LEVEL_THRESHOLD               = new ConfigInteger("lightLevelThreshold", 1, 0, 15, "The light level threshold which is considered safe");
