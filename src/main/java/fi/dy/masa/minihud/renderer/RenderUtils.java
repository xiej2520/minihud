...
public class RenderUtils
{
                                              ...
                                              BufferBuilder buffer)
    {
        ...
        switch (side)
        {
            case WEST:  minX += inset; break;
            case EAST:  minX += 1 - inset; break;
            case NORTH: minZ += inset; break;
            case SOUTH: minZ += 1 - inset; break;
            case DOWN:  minY += inset; break;
            case UP:    minY += 1 - inset; break;
        }
