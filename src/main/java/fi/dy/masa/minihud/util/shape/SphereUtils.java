...
public class SphereUtils
{
    ...
    {
        switch (axis) {
            case X: return Direction.WEST;
            case Y: return Direction.DOWN;
            case Z: return Direction.NORTH;
        }
        // unreachable
    ...
    {
        switch (axis1) {
            case X: return axis2 == Direction.Axis.Y ? Direction.Axis.Z : Direction.Axis.Y;
            case Y: return axis2 == Direction.Axis.X ? Direction.Axis.Z : Direction.Axis.X;
            case Z: return axis2 == Direction.Axis.X ? Direction.Axis.Y : Direction.Axis.X;
        }
        // unreachable;
