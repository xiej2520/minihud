...
public class MobCapData
{
    ...
    public Cap getCap(EntityCategoryWrapper type)
    {
        return this.data[type.ordinal()];
    }

    public void setCurrentValue(EntityCategoryWrapper type, int currentValue, long worldTick)
    {
    ...
    public void setCapValue(EntityCategoryWrapper type, int capValue, long worldTick)
    {
        int index = type.ordinal();
        Cap cap = this.stagingData[index];
        cap.setCap(capValue);
    ...
    public void setCurrentAndCapValues(EntityCategoryWrapper type, int currentValue, int capValue, long worldTick)
    {
        int index = type.ordinal();
    ...
    public enum EntityCategoryWrapper
    {
        MONSTER                     ("monster",                     EntityCategory.MONSTER),
        CREATURE                    ("creature",                    EntityCategory.CREATURE),
        AMBIENT                     ("ambient",                     EntityCategory.AMBIENT),
        //AXOLOTLS                    ("axolotls",                    EntityCategory.AXOLOTLS),
        //UNDERGROUND_WATER_CREATURE  ("underground_water_creature",  EntityCategory.UNDERGROUND_WATER_CREATURE),
        WATER_CREATURE              ("water_creature",              EntityCategory.WATER_CREATURE),
        //WATER_AMBIENT               ("water_ambient",               EntityCategory.WATER_AMBIENT),
        MISC                        ("misc",                        EntityCategory.MISC);

        private final EntityCategory vanillaCategory;
        private final String name;

        EntityCategoryWrapper(String name, EntityCategory vanillaCategory)
        {
            this.name = name;
        ...
        public EntityCategory getVanillaCategory()
        {
            return this.vanillaCategory;
        }

        public static EntityCategoryWrapper fromVanillaCategory(EntityCategory type)
        {
            switch (type)
            {
        ...
        @Nullable
        public static EntityCategoryWrapper fromVanillaCategoryName(String name)
        {
            switch (name)
            {
                case "monster":                     return MONSTER;
